...
go_golangci_lint_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_golangci_sarif": attr.label(
            default = Label("//tools/go/golangci_lint/wrapper"),
            executable = True,
            cfg = "exec",
        ),
...
java_pmd_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_pmd_sarif": attr.label(
            default = Label("//tools/java/pmd/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
java_cpd_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_cpd_sarif": attr.label(
            default = Label("//tools/java/cpd/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
java_spotbugs_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_spotbugs_sarif": attr.label(
            default = Label("//tools/java/spotbugs/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
python_pycompile_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_python_pycompile_sarif": attr.label(
            default = Label("//tools/python/pycompile/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
python_ruff_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_ruff_sarif": attr.label(
            default = Label("//tools/python/ruff/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
python_bandit_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_bandit_sarif": attr.label(
            default = Label("//tools/python/bandit/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
java_error_prone_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_error_prone_sarif": attr.label(
            default = Label("//tools/java/error_prone/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
rust_clippy_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_clippy_converter": attr.label(
            default = Label("//tools/rust/clippy/converter/cmd:converter"),
            executable = True,
            cfg = "exec",
        ),
    },
...
typescript_eslint_submission_aspect = aspect(
    ...
    attrs = {
        "_lint_config": attr.label(default = Label("@@//:gavel_lint_config")),
        "_eslint": attr.label(
            default = Label("//tools/typescript/eslint"),
            executable = True,
            cfg = "exec",
        ),
        "_eslint_sarif": attr.label(
            default = Label("//tools/typescript/eslint/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
go_archtest_submission_aspect = aspect(
    ...
    attrs = {
        ...
        "_archtest_wrapper": attr.label(
            default = Label("//tools/go/archtest/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
java_archtest_submission_aspect = aspect(
    ...
    attrs = {
        "_lint_config": attr.label(default = Label("@@//:gavel_lint_config")),
        "_archtest_wrapper": attr.label(
            default = Label("//tools/java/archtest/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
python_archtest_submission_aspect = aspect(
    ...
    attrs = {
        "_lint_config": attr.label(default = Label("@@//:gavel_lint_config")),
        "_archtest_wrapper": attr.label(
            default = Label("//tools/python/archtest/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
rust_archtest_submission_aspect = aspect(
    ...
    attrs = {
        "_lint_config": attr.label(default = Label("@@//:gavel_lint_config")),
        "_archtest_wrapper": attr.label(
            default = Label("//tools/rust/archtest/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
...
typescript_archtest_submission_aspect = aspect(
    ...
    attrs = {
        "_lint_config": attr.label(default = Label("@@//:gavel_lint_config")),
        "_archtest_wrapper": attr.label(
            default = Label("//tools/typescript/archtest/wrapper"),
            executable = True,
            cfg = "exec",
        ),
    },
